...
class Vlans(ConfigBase):
    ...
    def set_state(self, want, have):
        ...
        :returns: the commands necessary to migrate the current configuration
                  to the desired configuration
        """
        root = junosutils.build_root_xml_node('vlans')
    ...
    def _state_merged(self, want, have):
        ...
        for config in want:
            ...
            vlan_root = junosutils.build_root_xml_node('vlan')
            junosutils.build_child_xml_node(vlan_root, 'name', vlan_name)
            junosutils.build_child_xml_node(vlan_root, 'vlan-id', vlan_id)
            if vlan_description:
                junosutils.build_child_xml_node(vlan_root, 'description',
                                                vlan_description)
