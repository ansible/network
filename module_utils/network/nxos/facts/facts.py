...
class Facts(FactsArgs, FactsBase):
    ...
    def _get_l3_interfaces(self, module, connection):
        return L3_interfacesFacts(L3_interfacesArgs.argument_spec, 'config', 'options').populate_facts(module, connection)
