...
from ansible.module_utils.network. \
    junos.config.l3_interfaces.l3_interfaces import L3_interfaces
# pylint: enable=C0413
...
description: This module provides declarative management of a Layer-3 interface
...
options:
  config:
    ...
    suboptions:
      ...
      unit:
        description:
          - Logical interface number. Value of C(unit) should be of type int
        default: 0
      ipv4:
        description:
          - IPv4 addresses to be set for the Layer 3 logical interface
            mentioned in I(name) option. The address format is
            <ipv4 address>/<mask>, the mask is number in range 0-32
            for example, 192.0.2.1/24, or C(dhcp) to query DHCP for an IP
            address
        type: list
        elements: dict
        suboptions:
      ...
      ipv6:
        description:
          - IPv6 addresses to be set for the Layer 3 logical interface
            mentioned in I(name) option. The address format is
            <ipv6 address>/<mask>, the mask is number in range 0-128
