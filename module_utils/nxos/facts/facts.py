...
from ansible.module_utils.nxos.argspec.l2_interfaces.l2_interfaces import L2_interfacesArgs
from ansible.module_utils.nxos.facts.l2_interfaces.l2_interfaces import L2_interfacesFacts
...
class Facts(FactsArgs, FactsBase):
        ...
        if self.VALID_GATHER_SUBSETS:
            ...
            if runable_subsets:
                ...
                for key, value in iteritems(facts):
                    ...
                    if key.startswith('_'):
                        self.ansible_facts[key[1:]] = value
                    else:
    ...
    def _get_l2_interfaces(self, module, connection):
